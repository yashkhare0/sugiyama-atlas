...
export type JourneyRoute = {
  ...
  path: string;
  redirects: string[];
  unresolvedRedirects?: Array<{ evidence: Evidence; expression: string }>;
};

export type JourneyNodeKind =
  "action" | "code-boundary" | "completed-outcome" | "dead-end" | "dynamic-destination" | "external-exit" | "screen" | "unresolved-path" | "view-state";
